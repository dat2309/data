    ...
    html.Div([
        ...
        html.Div([
            ...
            html.Div([
                ...
                html.Div([
                  html.Img(src='data:image/png;base64,{}'.format(encoded_image.decode()),className= 'col-9',style={'align':'center'}),
                   html.Img(src='data:image/png;base64,{}'.format(encoded_image1.decode()),className= 'col-9',style={'align':'center'})  ,   
                ],className='row'),
                 html.Div([
                     html.Img(src='data:image/png;base64,{}'.format(encoded_image2.decode()),className= 'col-9',style={'align':'center'}),
                     html.Img(src='data:image/png;base64,{}'.format(encoded_image3.decode()),className= 'col-9',style={'align':'center'}),                     
                 ],className ='row'),
                  html.Div([
                      html.Img(src='data:image/png;base64,{}'.format(encoded_image4.decode()),className= 'col-9',style={'align':'center'}),
                       html.Img(src='data:image/png;base64,{}'.format(encoded_image5.decode()),className= 'col-9',style={'align':'center'}),
                   ],className ='row')
        ],className='col-9 bg-light',style={'border-radius': '3px','padding': '20px 40px'}),
    ], className = 'row')
], className='container')
